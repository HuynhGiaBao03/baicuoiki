    ...
    useEffect(() => {
        ...
        if (activedTrackEl) {
            if (persent2 <= persent1) {
                ...
                activedTrackEl.style.right = `${100 - persent1}%`// neu 2 di qua 1 thi 2 thanh 1
            } else {
                activedTrackEl.style.left = `${persent1}%`
                activedTrackEl.style.right = `${100 - persent2}%`// nguoc lai
            }
        }
    }, [persent1, persent2])
                ...
                {(name === 'price' || name === 'area') && <div className='p-12 py-20 '>
                    <div className='flex flex-col items-center justify-center relative'>
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                setPersent1(+e.target.value)// num keo
