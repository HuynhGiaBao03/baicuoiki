    ...
    return (
        <div>
            ...
            <div className='w-full flex flex-col gap-4'>
                <div className='w-1/2'><Select value={payload.categoryCode} setValue={setPayload} name='categoryCode' options={categories} label='Loại chuyên mục' setInvalidFields={setInvalidFields} invalidFields={invalidFields} /></div>
                <InputFormV2 value={payload.title} setValue={setPayload} name='title' label='Tiêu đề' setInvalidFields={setInvalidFields} invalidFields={invalidFields} />
